...
for count in range(0, dataset_length, 1):
    ...
    pipe1.rotate(pipe1.get_rotation_matrix_from_xyz((rx, ry, rz)),
                center= pipe1.get_center()) # aumentation - rotation
    ...
    pipe_xyz = pipe_xyz1[random_indices, :] # randomizing subsampling in point cloud to make it non-uniform
    #print("random sampled ", np.shape(pipe_xyz))
    ...
    print('dataset generation progress ', count*100/dataset_length, '%', '\r')
